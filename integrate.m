function [y,opt4biomass,opt4target,opt4f,opt5biomass] =...
...
%'integrate' employs linear programming twice in the designated grid.
...
[opt4.x, opt4.f, opt4.stat] = gurobiLinProg(lp.f, lp.A, lp.b, lp.Aeq, lp.beq, lp.lb, lp.ub);
